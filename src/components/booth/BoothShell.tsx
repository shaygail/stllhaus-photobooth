...
export function BoothShell({ children, className = "" }: BoothShellProps) {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-dvh w-full max-w-lg flex-col px-5 pb-10 pt-[max(1.25rem,env(safe-area-inset-top))] sm:max-w-xl sm:px-6 md:max-w-3xl md:px-8">
        {children}
      </div>
    </div>
  );
